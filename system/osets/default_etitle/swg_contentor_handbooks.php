...
NOTE_END //n*/
/**
* osets/default_etitle/swg_contentor_handbooks.php
*
...
$f_return = ("<table cellspacing='1' summary='' class='pageborder1' style='width:100%;table-layout:auto'>
<thead><tr>
<td colspan='$f_cat_colspan' align='left' class='pagetitlecellbg' style='padding:$direct_settings[theme_td_padding]'><span class='pagetitlecellcontent'><a href=\"{$direct_cachedata['output_cat']['pageurl']}\" target='_self'>{$direct_cachedata['output_cat']['title']}</a></span></td>
</tr></thead><tbody>");
