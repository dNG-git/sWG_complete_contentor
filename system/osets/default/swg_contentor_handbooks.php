...
----------------------------------------------------------------------------
$Id: swg_contentor_handbooks.php,v 1.3 2009/03/28 07:56:07 s4u Exp $
#echo(sWGcontentorVersion)#
sWG/#echo(__FILEPATH__)#
----------------------------------------------------------------------------
NOTE_END //n*/
/**
* osets/default/swg_contentor_handbooks.php
*
...
//f// direct_output_oset_contentor_handbooks_list ()
/**
* direct_output_oset_contentor_handbooks_list ()
*
* @uses   direct_debug()
...
* @since  v0.1.00
*/
function direct_output_oset_contentor_handbooks_list ()
{
	global $direct_cachedata,$direct_classes,$direct_settings;
	if (USE_debug_reporting) { direct_debug (5,"sWG/#echo(__FILEPATH__)# -direct_output_oset_contentor_handbooks_list ()- (#echo(__LINE__)#)"); }
...
<thead><tr>
<td colspan='$f_cat_colspan' align='left' class='pagetitlecellbg' style='padding:$direct_settings[theme_td_padding]'><span class='pagetitlecellcontent'>$f_cat_title</span></td>
</tr></thead><tbody>");
...
<td align='center' class='pageextrabg' style='width:10%;padding:$direct_settings[theme_td_padding]'><span class='pageextracontent' style='font-size:10px'><span style='font-weight:bold'>".(direct_local_get ("contentor_docs")).":</span> {$direct_cachedata['output_cat']['docs']}</span></td>
		...
		if (!empty ($direct_cachedata['output_cats'])) { $f_return .= "<span style='font-size:8px'>&#0160;</span>".(direct_contentor_oset_cats_parse ($direct_cachedata['output_cats'],"simple")); }
	}
	else { $f_return = ""; }
...
//f// direct_output_oset_contentor_handbooks_view ()
/**
* direct_output_oset_contentor_handbooks_view ()
*
* @uses   direct_debug()
* @uses   USE_debug_reporting
* @return string Valid XHTML code
* @since  v0.1.00
*/
function direct_output_oset_contentor_handbooks_view ()
{
	global $direct_cachedata,$direct_classes,$direct_settings;
	if (USE_debug_reporting) { direct_debug (5,"sWG/#echo(__FILEPATH__)# -direct_output_oset_contentor_handbooks_view ()- (#echo(__LINE__)#)"); }
...
<td align='center' class='pageextrabg' style='width:10%;padding:$direct_settings[theme_td_padding]'><span class='pageextracontent' style='font-size:10px'><span style='font-weight:bold'>".(direct_local_get ("contentor_docs")).":</span> {$direct_cachedata['output_cat']['docs']}</span></td>
	...
	{
		if (strlen ($direct_cachedata['output_doc']['title_alt'])) { $f_return .= "<p class='pagecontenttitle'>{$direct_cachedata['output_doc']['title_alt']}</p>\n"; }
		else { $f_return .= "<p class='pagecontenttitle'>{$direct_cachedata['output_doc']['title']}</p>\n"; }
...
//f// direct_output_oset_contentor_handbooks_versions ()
/**
* direct_output_oset_contentor_handbooks_versions ()
*
* @uses   direct_debug()
* @uses   USE_debug_reporting
* @return string Valid XHTML code
* @since  v0.1.00
*/
function direct_output_oset_contentor_handbooks_versions ()
{
	global $direct_cachedata,$direct_classes,$direct_settings;
	if (USE_debug_reporting) { direct_debug (5,"sWG/#echo(__FILEPATH__)# -direct_output_oset_contentor_handbooks_versions ()- (#echo(__LINE__)#)"); }
